...
public class Utils {
  ...
  public static GitHubWithCache getGitHub(String user, String password, Path cacheDir, int cacheMB)
      throws IOException {
    ...
    if (cacheDir != null) {
      ...
      ghBuilder.withConnector(new OkHttpGitHubConnector(okHttpClient));
    }
